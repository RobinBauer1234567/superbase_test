                ...
                return [
                  SliverOverlapAbsorber(
                    ...
                    sliver: SliverAppBar(
                      ...
                      title: _buildCollapsedPlayerBar(),
                    ...
                    builder: (context) => CustomScrollView(
                      ...
                      slivers: [
                        ...
                        if (teamMatches.isEmpty)
                          const SliverFillRemaining(hasScrollBody: false, child: Center(child: Text('Keine Spiele vorhanden')))
                        else
                          SliverList.builder(
